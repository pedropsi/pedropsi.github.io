///////////////////////////////////////////////////////////////////////////////
//Kudomono Editor (c) Pedro PSI, 2020-2021.
///////////////////////////////////////////////////////////////////////////////
...
FruitIcons={
	"apple":{
		...
		initial:"A",
		colour:"hsl(0,255,77)",
		transform:"rescale-width-20",
		viewBox:"0 0 1691 1192"
	},
	"blueberry":{
		initial:"B",
		colour:"hsl(170,255,77)",
	...
	"melon":{
		initial:"M",
		colour:"hsl(68,109,61)",
		viewBox:"0 0 2360 1556",
	...
	"grape":{
		initial:"G",
		colour:"hsl(213,255,53)",
		viewBox:"0 0 2480 1635",
		path:"M 372 19 C 364 31 360 41 362 43 C 364 44 407 71 458 102 C 508 134 550 163 550 169 C 550 182 520 210 464 249 C 425 276 405 283 368 283 C 312 283 277 311 255 374 C 246 403 236 414 218 416 C 178 421 153 439 129 482 C 109 516 105 536 107 594 C 108 660 106 667 84 679 C 0 723 -14 906 60 980 C 79 998 99 1008 119 1008 C 143 1008 152 1014 165 1043 C 174 1062 188 1082 196 1089 C 206 1097 208 1115 204 1157 C 196 1229 214 1293 251 1331 C 276 1355 287 1359 320 1356 C 357 1353 360 1354 376 1393 C 385 1415 395 1455 396 1483 C 401 1552 437 1618 482 1643 C 519 1662 520 1663 554 1644 C 574 1633 596 1610 606 1589 C 624 1551 630 1471 618 1427 C 611 1403 612 1402 640 1406 C 706 1416 760 1340 760 1239 C 760 1197 766 1169 780 1145 C 820 1078 815 971 768 905 C 749 879 749 876 765 833 C 785 781 782 699 758 652 C 750 634 746 614 750 607 C 769 573 771 507 756 455 C 731 369 672 331 612 362 C 595 371 576 386 571 395 C 563 408 561 390 560 327 L 560 242 L 622 159 C 681 79 683 75 665 62 C 647 49 643 51 614 85 L 583 122 L 504 73 C 461 46 416 19 405 11 C 387 0 383 1 372 19 Z M 498 409 C 478 422 476 421 459 373 L 442 328 L 474 303 L 505 278 L 508 340 C 510 382 507 404 498 409 Z",
		transform:"rescale-height-20"
	}
}

Icons={...Icons,...FruitIcons};
...
function MarkPolygons(cells,opts){
	...
	DrawRectangles(opts,cells.map(k=>STATE.polygons[k])
	)
}
...
SetFruit=function(initial){
	var fruits=Keys(FruitIcons).filter(k=>FruitIcons[k].initial===initial);
	if(fruits.length){
		STATE.symbol=FruitIcons[First(fruits)].initial;
		console.log(STATE.symbol);
	}
}

Keys(FruitIcons).map(f=>KeyboardActions[f.initial]=ActionSwitcher(f.initial,SetFruit));
