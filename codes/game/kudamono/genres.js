...
var Genres={
	"bonsai":{
		...
		rules:{
			shapesnosymbol:["L","U","R","D","LR","UD","LUR","URD","RDL","DLU"],
		},
		symbols:{
			"flower":{
				letter:"w",
	...
	"subway":{
		...
		rules:{
			shapesnosymbol:["LR","LE","LS","RN","RW","UD","UW","US","DN","DE","NS","EW","LURD","NESW"],
		},
		symbols:{
			"station":{
				letter:"t",
				...
				rule:{
					shapesatsymbolallowed:["LU","UD","NS","EW"]
				}
			},
			"park-N":{
				letter:"n",
