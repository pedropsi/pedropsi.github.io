...
var Genres={
	"bonsai":{
		...
		author:"Le Slo",
		date:"2021-01-18",
		description:`Pave the whole grid with a continuous path, rooted to the bottom via a straight trunk.
		...
		rules:{
			...
			"consecutives":{
				...
				depiction:"W=4&H=3&L=h5&S=6q&G=b",
		...
		fruits:{
			...
			"flower":{
				...
				rule:{
					fruitshapes:Shape1s,
					description:"each flower blossoms at an endpoint",
			...
			"fruit":{
				...
				rule:{
					...
					description:"each fruit is attached to a straight trunk",
			...
			"hummingbird":{
					...
					rule:{
						...
						description:"each hummingbird rests at a corner",
						depiction:"W=4&L=h6h2&S=7V4O2N3D2U&G=b"
					},
			},
			"question":{
				letter:"q",
