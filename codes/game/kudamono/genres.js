		...
		fruits:{
			"flower":{
				...
				rule:{
					fruitshapes:Shape1s,
					minconnected:Infinity,
					description:"each flower blossoms at an endpoint (1-piece)",
			...
			"fruit":{
				...
				rule:{
					...
					minconnected:Infinity,
					description:"each fruit occupies a straight trunk (2-piece)",
			...
			"hummingbird":{
					...
					rule:{
						...
						minconnected:Infinity,
						description:"each hummingbird must be at a corner (2-piece)",
