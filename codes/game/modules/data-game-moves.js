...
DeployWon=function(jsonstring){
	...
	AddChart({
		...
		"XLegend":{txt:"Level",x:0.6,y:1.0,size:0.08},
		"YLegend":{txt:"Wins total",y:0,x:0.05,size:0.1},
		"YAxisLegend":{values:"Wins total",major:4,min:0,max:ScaleMax(max),down:-3/10,horizontal:true},
		"XAxisLegend":{values:"Wins total",major:wins.length,min:0,max:wins.length,down:-1/10},
