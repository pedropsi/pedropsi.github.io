...
TouchActionsPuzzlescript=function(){
	...
	"swipe-left":GameKeyHandler(37),
	"swipe-up":GameKeyHandler(38),
	"swipe-right":GameKeyHandler(39),
	"swipe-down":GameKeyHandler(40)
	}
}

LaunchTouchActions(ObtainGameSelector(),TouchActionsPuzzlescript())
