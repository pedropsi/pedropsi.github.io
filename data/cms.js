...
P_guestbook:{LINK:()=>`guestbook`,BODY:()=>v.PAGE_BARE(),CONTENT:()=>v.GUESTBOOK_AREA(),TITLE:()=>`Guestbook`,DAY:()=>`22`,MONTH:()=>`7`,YEAR:()=>`2018`,TYPE:()=>`Guestbook`,TAGS:()=>[`Creative-Archive`],IMAGE_NAME:()=>`guestbook`,IMAGEALT:()=>`Write your message on the ${v.SITE_NAME()}'s guestbook!`,DESCRIPTION:()=>`The Guestbook of the ${v.SITE_NAME()}!`,TYPEGRAPH:()=>`website`,DISPLAY_LEGACY_CODE:()=>"2036979410"},
