...
P_lul:{...WithImage,LINK:()=>`lul`,TITLE:()=>`Level unlocking language`,SHORTNAME:()=>`LUL`,DAY:()=>`30`,MONTH:()=>`11`,YEAR:()=>`2019`,TAGS:()=>[`Resource`,`Tutorial`],ONE_LINER:()=>`${v.TITLE()} (LUL) is a simple language to express level precedence rules, also known as level unlocking conditions.`},
...
P_fleur_de_lis:{...CMSMosaic,LINK:()=>`fleur-de-lis`,TITLE:()=>`Fleur de Lis - Navy Gold`,SHORTNAME:()=>`Fleur de lis`,DAY:()=>`14`,MONTH:()=>`2`,YEAR:()=>`2018`,TAGS:()=>[`Art`,`Mosaic`,`Travel`,`Wallpaper`],IMAGE_ALT:()=>`Fleur de lis wallpaper in Navy Gold`},
P_scales:{...CMSMosaic,LINK:()=>`scales`,TITLE:()=>`Scales - Grayed`,SHORTNAME:()=>`Scales`,DAY:()=>`24`,MONTH:()=>`11`,YEAR:()=>`2017`,TAGS:()=>[`Art`,`Mosaic`,`Wallpaper`],IMAGE_ALT:()=>`Scales wallpaper`},
P_veronese:{...CMSMosaic,LINK:()=>`veronese`,TITLE:()=>`Veronese - Tricolor`,SHORTNAME:()=>`Veronese`,DAY:()=>`6`,MONTH:()=>`2`,YEAR:()=>`2018`,TAGS:()=>[`Art`,`Mosaic`,`Travel`,`Wallpaper`],IMAGE_ALT:()=>`Veronese tricolor wallpaper`},
P_viking_carpet:{...CMSMosaic,LINK:()=>`viking-carpet`,TITLE:()=>`Viking Carpet - Gold over Red`,SHORTNAME:()=>`Viking Carpet`,DAY:()=>`10`,MONTH:()=>`10`,YEAR:()=>`2017`,TAGS:()=>[`Art`,`Mosaic`,`Travel`,`Wallpaper`],IMAGE_ALT:()=>`Viking red and gold wallpaper`},
...
P_index:{...NoImage,LINK:()=>`index`,BODY:()=>v.POST(),TITLE:()=>v.SITE_NAME(),DAY:()=>`1`,MONTH:()=>`12`,YEAR:()=>`2017`,TYPE:()=>`Home`,TAGS:()=>[`Sitemap`],DESCRIPTION:()=>`${v.SITE_NAME()} home page.`,TYPEGRAPH:()=>`website`},
P_guestbook:{...WithImage,LINK:()=>`guestbook`,BODY:()=>v.PAGE_BARE(),CONTENT:()=>v.GUESTBOOK_AREA(),TITLE:()=>`Guestbook`,DAY:()=>`22`,MONTH:()=>`7`,YEAR:()=>`2018`,TYPE:()=>`Guestbook`,TAGS:()=>[`Creative-Archive`],IMAGE_ALT:()=>`Write your message on the ${v.SITE_NAME()}'s guestbook!`,DESCRIPTION:()=>`The Guestbook of the ${v.SITE_NAME()}!`,TYPEGRAPH:()=>`website`,DISPLAY_LEGACY_CODE:()=>"2036979410"},
...
P_strata_hedges:{...CMSGame,...NoImage,LINK:()=>`strata-hedges`,CONTENT:()=>`74e3b230123627da73d1466eea865f5b`,THEMECOLOUR:()=>`rgb(0,101,101)`,TITLE:()=>`Strata Hedges`,DAY:()=>`29`,MONTH:()=>`3`,YEAR:()=>`2020`,TAGS:()=>[`3D`,`Game`,`Puzzle`,`Puzzlescript`],ONE_LINER:()=>`<p>The gardens in ${v.TITLE_BOLD()} have many dimensions. Sharpen your eyes and keep all in perspective!</p>`},
P_game_console:{...CMSGame,LINK:()=>`game-console`,TITLE:()=>`Game Console`,DAY:()=>`29`,MONTH:()=>`10`,YEAR:()=>`2019`,TYPE:()=>`Console`,TAGS:()=>[`Community`,`Puzzlescript`,`Resource`],ONE_LINER:()=>`Load any puzzlescript game in ${v.NAME()}'s console and to use the game bar!`,TYPEGRAPH:()=>`website`,MANIFEST:()=>`${v.PWA_MANIFEST()}`,IMAGE_EXT:()=>"svg"},
P_puzzle_type:{...CMSGame,LINK:()=>`puzzle-type`,POSTSCRIPT:()=>v.GAME_SCRIPT(),TITLE:()=>`Puzzle type`,DAY:()=>`10`,MONTH:()=>`11`,YEAR:()=>`2019`,TAGS:()=>[`Game`,`Puzzle`],FEATURED:()=>true,IMAGE_EXT:()=>`gif`,ONE_LINER:()=>`<p>Are you the ${v.TITLE_BOLD()}? Find out in this cryptic keyboard typing puzzle!</p>`,ORIENTATION:()=>`portrait`,FEEDBACK_KEY:()=>"<kbd>Alt</kbd>+<kbd>E</kbd>",FULLSCREEN_KEY:()=>"<kbd>Alt</kbd>+<kbd>F</kbd>",HINT_KEY:()=>"<kbd>Alt</kbd>+<kbd>H</kbd>",LEVEL_KEY:()=>"<kbd>Alt</kbd>+<kbd>L</kbd>",MUSIC_KEY:()=>"<kbd>Alt</kbd>+<kbd>M</kbd>"},
