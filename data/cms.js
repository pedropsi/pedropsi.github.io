...
P_platformer_template:{...CMSGame,LINK:()=>`platformer-template`,CONTENT:()=>`a59cd8147d80041f87181599f5d6cd2e`,THEMECOLOUR:()=>`rgb(96,197,154)`,TITLE:()=>`Platformer Template`,DAY:()=>`22`,MONTH:()=>`4`,YEAR:()=>`2019`,TAGS:()=>[`Game`,`Platformer`,`Puzzle`,`Puzzlescript`],ONE_LINER:()=>`<p>${v.TITLE_BOLD()} is a puzzle about making puzzles. A meta-game that teaches players how to design a puzzle-platformer step by step.</p>`},
...
P_skilleblokker:{...CMSGame,LINK:()=>`skilleblokker`,CONTENT:()=>`d4716388dfe54118a82d4e1ec5d60bc4`,THEMECOLOUR:()=>`rgb(189,224,255)`,TITLE:()=>`Skilleblokker`,DAY:()=>`21`,MONTH:()=>`9`,YEAR:()=>`2019`,TAGS:()=>[`Game`,`Puzzle`,`Puzzlescript`],ONE_LINER:()=>`<p>It is time to disconnect with ${v.TITLE_BOLD()}, the opposite twin of Burokku Konekuta. Can you chill out and isolate every block or will you slip astray on the ice?</p>`},
...
P_starkoban:{...CMSGame,LINK:()=>`starkoban`,CONTENT:()=>`f20996db777cfb6f5725fd27c4268cf3`,THEMECOLOUR:()=>`rgb(55,55,55)`,TITLE:()=>`Starkoban`,DAY:()=>`14`,MONTH:()=>`11`,YEAR:()=>`2020`,TAGS:()=>[`Game`,`Puzzle`,`Puzzlescript`],FEATURED:()=>true,ONE_LINER:()=>`<p>${v.TITLE_BOLD()} is a challenging mix of star battle and sokoban, for stark puzzlers.</p>`},
...
P_insight:{...NoImage,FEATURED:()=>false,LINK:()=>`insight`,POSTSCRIPT:()=>["codes/game/modules/data-game-colours.js","data/worldmap.js"],TITLE:()=>`Analytics dashboard`,DAY:()=>`05`,MONTH:()=>`05`,YEAR:()=>`2020`,TYPE:()=>`Backend`,TAGS:()=>[`Creative-Archive`,`Sitemap`],ONE_LINER:()=>`Analytics dashboard of the ${v.SITE_NAME()}`},
...
P_kudamono:{...WithImage,LINK:()=>`kudamono`,TITLE:()=>`Kudamono fruit puzzles`,DAY:()=>`18`,MONTH:()=>`12`,YEAR:()=>`2020`,TYPE:()=>`Post`,TAGS:()=>[`Paper`,`Puzzle`],ONE_LINER:()=>`Kumamono (fruits) is a paper puzzle, where you draw lines to connect fruits, with different rules for different fruit types.`,IMAGE_EXT:()=>`png`}
