...
CMS={
"index":{...NoImage,BODY:()=>v.POST(),TITLE:()=>v.SITE_NAME(),DATE:()=>"2017-12-01",TYPE:()=>`Home`,TAGS:()=>[`Sitemap`],DESCRIPTION:()=>`${v.SITE_NAME()} home page.`,TYPEGRAPH:()=>`website`},
"purpose":{...NoImage,TITLE:()=>`The purpose of the ${v.SITE_NAME()}`,SHORTNAME:()=>`Purpose`,DATE:()=>"2017-12-01",TAGS:()=>[`Creative-Archive`,`Post`],ONE_LINER:()=>`${v.SITE_NAME()}'s first post!`},
"support":{...NoImage,TITLE:()=>`Support the ${v.SITE_NAME()}`,SHORTNAME:()=>`Suport`,DATE:()=>"2018-02-08",TAGS:()=>[`Creative-Archive`,`Finance`,`Post`],ONE_LINER:()=>`Support the ${v.SITE_NAME()}!`},
"making-of":{...NoImage,TITLE:()=>`The making of the ${v.SITE_NAME()}`,SHORTNAME:()=>`making-of`,DATE:()=>"2019-12-15",TAGS:()=>[`Creative-Archive`,`Finance`,`Post`],ONE_LINER:()=>`Support the ${v.SITE_NAME()}!`},

"selected-puzzlescript-games":{...WithImage,FEATURED:()=>true,TITLE:()=>`Selected Puzzlescript Games 2014-${Year()}`,SHORTNAME:()=>`Selected PS Games`,DATE:()=>"2019-01-31",TAGS:()=>[`List`,`Post`,`Puzzlescript`],ONE_LINER:()=>`This is a <em>short</em> list of <em>very good</em> puzzlescript games, in ${v.MY()} opinion. It serves as a <em>${v.PERSONAL()}</em>, yet publicly shared, reference (to be updated whenever needed).`},
"11-lessons-from-11-games":{...WithImage,TITLE:()=>`11 Lessons from a 11-game-making journey`,SHORTNAME:()=>`Lessons`,DATE:()=>"2019-04-14",TAGS:()=>[`Game`,`Learning`,`List`,`Post`]},
...
"mosaic":{...WithImage,IMAGE_NAME:()=>"fleur-de-lis",IMAGE_EXT:()=>"png",TITLE:()=>`Mosaic wallpaper gallery`,DATE:()=>"2018-02-14",TAGS:()=>[`Art`,`Travel`,`Wallpaper`],IMAGE_ALT:()=>`Wallpaper gallery`},

"about":{...NoImage,CONTENT:()=>v.POST(),TITLE:()=>`About`,DATE:()=>"2018-02-02",TAGS:()=>[`Creative-Archive`,`Post`],TYPEGRAPH:()=>`profile`},
"404":{...NoImage,BODY:()=>v.PAGE_SIMPLE(),CONTENT:()=>v.POST(),TITLE:()=>`Page not found….`,SHORTNAME:()=>`404`,DATE:()=>"2017-12-01",TYPE:()=>`Backend`,TAGS:()=>[`Sitemap`],DESCRIPTION:()=>`Page not found in ${v.SITE_NAME()}.`,TYPEGRAPH:()=>`website`},
"guestbook":{...WithImage,BODY:()=>v.PAGE_BARE(),CONTENT:()=>v.GUESTBOOK_AREA(),TITLE:()=>`Guestbook`,DATE:()=>"2018-07-22",TYPE:()=>`Guestbook`,TAGS:()=>[`Creative-Archive`],IMAGE_ALT:()=>`Write your message on the ${v.SITE_NAME()}'s guestbook!`,DESCRIPTION:()=>`The Guestbook of the ${v.SITE_NAME()}!`,TYPEGRAPH:()=>`website`},
"contact":{...NoImage,TITLE:()=>`Contact`,TYPE:()=>`Backend`,TAGS:()=>[`Sitemap`],DESCRIPTION:()=>`Leave a message to contact ${v.NAME()}`,TYPEGRAPH:()=>`website`},
"hall-of-fame":{...WithImage,BODY:()=>v.PAGE_BARE(),CONTENT:()=>v.TABULAR_AREA(),POSTSCRIPT:()=>["data/hof.js"],TITLE:()=>`Hall of Fame`,SHORTNAME:()=>`HOF`,DATE:()=>"2018-03-26",TYPE:()=>`Hall of Fame`,TAGS:()=>[`Creative-Archive`,`Community`],IMAGE_ALT:()=>`Hall of fame of the ${v.SITE_NAME()}. Laurel and stars.`,ONE_LINER:()=>`<p>Puzzlers who solved any of the puzzles in the ${v.SITE_NAME()} earn the right to record their name (or alias) for posterity in the ${A("hall-of-fame")}.</p>`,DESCRIPTION:()=>`Hall of fame: winners of ${v.NAME()}'s challenges.`,TYPEGRAPH:()=>`website`},
"hall-of-fame-global":{...WithImage,BODY:()=>v.PAGE_BARE(),CONTENT:()=>v.TABULAR_AREA(),POSTSCRIPT:()=>["data/hof.js"],TITLE:()=>`Hall of Fame (global)`,SHORTNAME:()=>`HOFG`,DATE:()=>"2020-05-24",TYPE:()=>`Hall of Fame`,TAGS:()=>[`Community`],IMAGE_ALT:()=>`Hall of fame (global). Laurel and stars.`,ONE_LINER:()=>`<p>After beating a game listed in the ${A("puzzlescript-games-database")}, puzzlers anywhere in the globe may add their name (or alias) to this ${v.TITLE_BOLD()}.</p>`,DESCRIPTION:()=>`Hall of fame: global winners.`,TYPEGRAPH:()=>`website`},
"tetrastrophe":{...CMSGame,CONTENT:()=>`f60664326442967c1fcd97bb36f1af94`,THEMECOLOUR:()=>`rgb(112,84,0)`,TITLE:()=>`Tetrastrophe`,DATE:()=>"2014-05-14",TAGS:()=>[`Game`,`Platformer`,`Puzzle`,`Puzzlescript`],ONE_LINER:()=>`<p>Blocks are falling from the sky! Reach the <em>flag</em> to avoid a catastrophe! There are 10 levels before reaching absolute safety.</p>`},
"blockworks":{...CMSGame,CONTENT:()=>`f9eb8a3e60ba1328a84c3e84db27563a`,THEMECOLOUR:()=>`rgb(69,0,0)`,TITLE:()=>`Blockworks`,DATE:()=>"2018-02-04",TAGS:()=>[`Game`,`Platformer`,`Puzzle`,`Puzzlescript`],ONE_LINER:()=>`<p>Place the blue <em>X Block</em> at the <em>goal</em> (white arrow).Take advantage of auxiliary blocks by thinking creatively and acting timely.</p><p>8 levels only comprise this action puzzle. Good luck!</p>`},
"whirlpuzzle":{...CMSGame,CONTENT:()=>`8c5602f47f158af57a2db271a8bf5185`,THEMECOLOUR:()=>`rgb(3,2,48)`,TITLE:()=>`Whirlpuzzle`,DATE:()=>"2018-03-01",TAGS:()=>[`Game`,`Puzzle`,`Puzzlescript`],ONE_LINER:()=>`<p>Find a path to the goal, by rotating the puzzle to displace obstacles and reach inaccessible locations! But beware, whirling too much will only confuse you… </p><p>Can you solve all 7 levels in ${v.TITLE_BOLD()}? Good luck!</p>`},
"unlucky-unlock":{...CMSGame,CONTENT:()=>`9ad4b5559a3e39d9ae0aa5829b02b473`,THEMECOLOUR:()=>`rgb(28,38,50)`,TITLE:()=>`Unlucky Unlock`,DATE:()=>"2014-07-18",TAGS:()=>[`Game`,`Puzzle`,`Puzzlescript`],FEATURED:()=>true,ONE_LINER:()=>`<p>${v.TITLE_BOLD()} is a simple mini game of the sliding block type. Moving the pieces to the right positions unlocks each next level.</p> <p>There are four easier levels + three harder levels.</p>`},
"pmgrp":{...CMSGame,CONTENT:()=>`de00799ea3c9bfb0be74d1030a04c142`,THEMECOLOUR:()=>`rgb(4,71,0)`,TITLE:()=>`Play Mini Gemini Replay (PMGRP)`,SHORTNAME:()=>`PMGRP`,DATE:()=>"2018-03-20",TAGS:()=>[`Game`,`Platformer`,`Puzzle`,`Puzzlescript`],FEATURED:()=>true,ONE_LINER:()=>`<p>${v.TITLE_BOLD()} is a mini puzzle platformer about cooperating with your future self to reach your goals.</p><p>Plan your limited moves wisely, play and replay all 11 levels!</p>`},
"combinatura":{...WithImage,IMAGE_EXT:()=>"png",POSTSCRIPT:()=>v.GAME_SCRIPT(),TITLE:()=>`Combinatura`,DATE:()=>"2018-07-06",TYPE:()=>`Game`,TAGS:()=>[`Game`,`Prototype`,`Nature`,`Travel`],ONE_LINER:()=>`<p>${v.TITLE_BOLD()} is an exploration game that emphasises <b>learning</b> and <b>curiosity</b> about <b>natural phenomena</b>, especially in the domains of astronomy, geology, meteorology and ecology. As many obscure phenomena are discoverable in-Game, ${v.TITLE_BOLD()} teaches everyone something about the natural word.</p>`,TAGLINE:()=>"a game of exploration"},
"hastefulll":{...CMSGame,CONTENT:()=>`8b10ae059158c0c4a93c05c9437d0706`,THEMECOLOUR:()=>`rgb(6,71,117)`,TITLE:()=>`Hastefulll`,DATE:()=>"2018-07-12",TAGS:()=>[`Game`,`Platformer`,`Puzzle`,`Puzzlescript`],FEATURED:()=>true,ONE_LINER:()=>`<p>${v.TITLE_BOLD()} is a simple 7-level puzzle platformer about trying to leave a mark everywhere, as fast as possible. However, too much haste may have negative consequences!</p><p>Fill the board, but plan wisely. Haste makes waste!</p>`},
"tiaradventur":{...CMSGame,CONTENT:()=>`04e9b3dc13d2708e64a0adc4ddb916a0`,THEMECOLOUR:()=>`rgb(133,0,38)`,TITLE:()=>`Tiaradventur`,DATE:()=>"2018-08-28",TAGS:()=>[`Game`,`Puzzle`,`Role-playing`,`Puzzlescript`],FEATURED:()=>true,ONE_LINER:()=>`<p>A desperate Princess, on a quest to find seven stolen tiaras, asks for your help. As a Hero in the making, you must not refuse, even in the face of danger! As the story unfolds, you may get to know the Princess better and understand what really is at stake.</p><p>The <em>legend of</em> ${v.TITLE_BOLD()} is yours to write! How much intelligence you dedicate to this <b>role-playing puzzle</b> is up to you...</p>`},
"abxtract-tractx":{...CMSGame,CONTENT:()=>`44de3ef66dcfdce30c1eec78c3ea201c`,THEMECOLOUR:()=>`rgb(255,215,162)`,TITLE:()=>`Abxtract Tractx`,DATE:()=>"2018-10-04",TAGS:()=>[`Art`,`Game`,`Puzzle`,`Puzzlescript`],FEATURED:()=>true,ONE_LINER:()=>`<p>Do you think Abstract Art is too simple to be considered art? Try reproducing all 6 iconic abstract paintings in the very puzzling ${v.TITLE_BOLD()}!</p>`},
"gravirinth-legacy":{...CMSGame,CONTENT:()=>`c29dda29b38d830d4f48e6578494fb35`,THEMECOLOUR:()=>`rgb(25,4,52)`,TITLE:()=>`Gravirinth Legacy`,DATE:()=>"2019-01-07",TAGS:()=>[`Game`,`Platformer`,`Puzzle`,`Puzzlescript`],FEATURED:()=>false,ONE_LINER:()=>`<p>According to legend, a forgotten civilization once mastered the power of gravity, which they used to travel across the Milky Way, in search for alien life. Eager at first to share their wisdom, soon they became aware that most alien life forms were not ready to receive this great power...</p><p>So an enigma was devised to test the intelligence of alien societies, a puzzle marvelous yet so obscure that finding it would be a challenge in the first place. Thus the <b>Gravirinth</b> were born, each hidden into the most promising solar systems.</p><p>In the next millennia, few <b>Gravirinth</b> were ever found, and even fewer yielded their secrets, a rare moment of great joy where two civilisations found they were not alone in the vast cosmos. In the Solar System too had once a <b>Gravirinth</b> been found, but its location was lost to mankind...</p><p><b>...until Xeno, the Exoarchaeologist, arrived.</b> Will the <b>Gravirinth</b> reveal its mysteries?</p>`,TRAILER:()=>"nq4ljKWdwsU",TRAILER_IMAGE:()=>"gravirinth/gravirinth-trailer.png",TAGLINE:()=>"an exoarchaeology expedition"},
"gravirinth":{...CMSGame,CONTENT:()=>`598580a1d8dbeb9b4a7e338527b44804`,THEMECOLOUR:()=>`rgb(25,4,52)`,TITLE:()=>`Gravirinth`,DATE:()=>"2020-09-26",TAGS:()=>[`Game`,`Platformer`,`Puzzle`,`Puzzlescript`],FEATURED:()=>true,ONE_LINER:()=>`<p>Inside the ${v.TITLE_BOLD()}, gravity is local. Manipulate it to collect all orbs!</p><p>This is a remake of the old ${AHTML("Gravirinth [Legacy]","gravirinth-legacy.html")}.</p>`,TAGLINE:()=>"Gravirinth remastered."},
"gravirinth-log":{...WithImage,TITLE:()=>`Gravirinth changelog`,SHORTNAME:()=>`Grav. Log`,DATE:()=>"2018-11-22",TAGS:()=>[`Creative-Archive`,`Log`,`Post`,`Puzzlescript`],IMAGE_EXT:()=>"png"},
"platformer-template":{...CMSGame,CONTENT:()=>`a59cd8147d80041f87181599f5d6cd2e`,THEMECOLOUR:()=>`rgb(96,197,154)`,TITLE:()=>`Platformer Template`,DATE:()=>"2019-04-22",TAGS:()=>[`Game`,`Platformer`,`Puzzle`,`Puzzlescript`],ONE_LINER:()=>`<p>${v.TITLE_BOLD()} is a puzzle about making puzzles. A meta-game that teaches players how to design a puzzle-platformer step by step.</p>`},
"burokku-konekuta":{...CMSGame,CONTENT:()=>`96384ea6851a66ff30c89a18995f5b8b`,THEMECOLOUR:()=>`rgb(55,199,199)`,TITLE:()=>`Burokku Konekuta`,DATE:()=>"2019-07-10",TAGS:()=>[`Game`,`Puzzle`,`Puzzlescript`],FEATURED:()=>true,ONE_LINER:()=>`<p>Tidiness rules in ${v.TITLE_BOLD()}. Connect all the scattered pieces together to regain the harmony within your puzzled mind. </p>`},
"skilleblokker":{...CMSGame,CONTENT:()=>`d4716388dfe54118a82d4e1ec5d60bc4`,THEMECOLOUR:()=>`rgb(189,224,255)`,TITLE:()=>`Skilleblokker`,DATE:()=>"2019-09-21",TAGS:()=>[`Game`,`Puzzle`,`Puzzlescript`],ONE_LINER:()=>`<p>It is time to disconnect with ${v.TITLE_BOLD()}, the opposite twin of Burokku Konekuta. Can you chill out and isolate every block or will you slip astray on the ice?</p>`},
"strata-hedges":{...CMSGame,CONTENT:()=>`74e3b230123627da73d1466eea865f5b`,THEMECOLOUR:()=>`rgb(0,101,101)`,TITLE:()=>`Strata Hedges`,DATE:()=>"2020-03-29",TAGS:()=>[`3D`,`Game`,`Prototype`,`Puzzle`,`Puzzlescript`],ONE_LINER:()=>`<p>The gardens in ${v.TITLE_BOLD()} have many dimensions. Sharpen your eyes and keep all in perspective!</p>`},
"starkoban":{...CMSGame,CONTENT:()=>`f20996db777cfb6f5725fd27c4268cf3`,THEMECOLOUR:()=>`rgb(55,55,55)`,TITLE:()=>`Starkoban`,DATE:()=>"2020-11-14",TAGS:()=>[`Game`,`Puzzle`,`Puzzlescript`],FEATURED:()=>true,ONE_LINER:()=>`<p>${v.TITLE_BOLD()} is a challenging mix of star battle and sokoban, for stark puzzlers.</p>`},
"puzzle-type":{...CMSGame,PRESCRIPT:()=>["data/store.js"],POSTSCRIPT:()=>v.GAME_SCRIPT(),TITLE:()=>`Puzzle type`,DATE:()=>"2019-11-10",TAGS:()=>[`Game`,`Puzzle`],FEATURED:()=>true,IMAGE_EXT:()=>`gif`,ONE_LINER:()=>`<p>A <b>single clue</b> reveals the <b>hidden typing rule</b>. Explore each puzzle to discover its rule. To win, type the clue exactly as shown: <b>every symbol counts</b>!</p>`,ORIENTATION:()=>`portrait`,FEEDBACK_KEY:()=>`${KB("Ctrl E")}`,FULLSCREEN_KEY:()=>`${KB("Ctrl F")}`,HINT_KEY:()=>`${KB("Ctrl H")}`,LEVEL_KEY:()=>`${KB("Ctrl L")}`,MUSIC_KEY:()=>`${KB("Ctrl M")}`},
"terms-of-use":{...NoImage,TITLE:()=>`Terms of use`,DATE:()=>"2017-11-30",TAGS:()=>[`Creative-Archive`,`Post`]},
"privacy-policy":{...NoImage,TITLE:()=>`Privacy Policy`,DATE:()=>"2018-02-10",TAGS:()=>[`Creative-Archive`,`Post`]},
"subscribe":{...WithImage,TITLE:()=>`Subscribe`,DATE:()=>"2018-12-06",TAGS:()=>[`Creative-Archive`,`Post`],IMAGE_ALT:()=>`Subscribe to ${v.SITE_NAME()} news!`,DESCRIPTION:()=>`Curious about the next project by ${v.NAME()}? Subscribe to ${v.SITE_NAME()}!`},
"rss":{...NoImage,BODY:()=>`${v.RSS()}`,TYPE:()=>`RSS`,TYPEGRAPH:()=>`website`,EXT:()=>`xml`},
"tag":{...NoImage,BODY:()=>v.PAGE_SIMPLE(),CONTENT:()=>TagPageHTML(),STYLE:()=>`archive`,TITLE:()=>PageTagText(),FREQ:()=>`monthly`,TYPE:()=>`Tag`,TAGS:()=>[`Class`],DESCRIPTION:()=>`All tagged posts in the ${v.SITE_NAME()}`,TYPEGRAPH:()=>"site"},
"generator":{...NoImage,POSTSCRIPT:()=>["data/news.js"],TITLE:()=>`${v.SITE_NAME()} Generator`,DATE:()=>"2020-03-26",TAGS:()=>[`Creative-Archive`,`Sitemap`],ONE_LINER:()=>`Generate ${v.SITE_NAME()}'s pages such as sitemap, rss and more!`},
"analytics":{...NoImage,FEATURED:()=>false,POSTSCRIPT:()=>["codes/game/modules/data-game-colours.js","data/worldmap.js"],TITLE:()=>`Analytics dashboard`,DATE:()=>"2020-05-05",TYPE:()=>`Backend`,TAGS:()=>[`Creative-Archive`,`Sitemap`],ONE_LINER:()=>`Analytics dashboard of the ${v.SITE_NAME()}`},
"videoplaytesting-tips":{...WithImagePNG,TITLE:()=>`Videoplaytesting Tips`,DATE:()=>"2020-08-29",TAGS:()=>[`List`,`Post`],ONE_LINER:()=>`Would you like to videoplaytest a game but not sure how to go about it? Here are some tips!`},

"star-battle":{...WithImagePNG,POSTSCRIPT:()=>["codes/game/star-battle/hyper-loader.js"],TITLE:()=>`Star Battle geometries`,DATE:()=>"2020-06-18",TYPE:()=>`Post`,TAGS:()=>[`Paper`,`Puzzle`],ONE_LINER:()=>`What if you could play <b>Star Battle</b> on <em>different geometries</em>? Now you can!`},
"kudamono":{...WithImagePNG,TITLE:()=>`Kudamono fruit puzzles`,DATE:()=>"2020-12-18",TYPE:()=>`Post`,TAGS:()=>[`Paper`,`Puzzle`],ONE_LINER:()=>`Kudamono (fruits) is a paper puzzle, where you draw lines to connect fruits, with different rules for different fruit types.`},
"thinky-collective":{...WithImagePNG,TITLE:()=>`Thinky Collective`,DATE:()=>"2019-10-21",TYPE:()=>`Post`,TAGS:()=>[`Post`,`List`],ONE_LINER:()=>`The ${v.TITLE_BOLD()} is a distributed group of puzzle enthusiasts, that produced a puzzlescript game series using an "exquisite corpse" methodology.`},
"bonsai":{...WithImagePNG,TITLE:()=>`Bonsai Gardening puzzles`,DATE:()=>"2021-01-30",TYPE:()=>`Post`,TAGS:()=>[`Paper`,`Puzzle`],ONE_LINER:()=>`Bonsai Gardening is a paper puzzle where you must draw the perfect bonsai.`},
