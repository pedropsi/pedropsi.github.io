...
P_puzzle_type:{...CMSGame,LINK:()=>`puzzle-type`,PRESCRIPT:()=>["data/store.js"],POSTSCRIPT:()=>v.GAME_SCRIPT(),TITLE:()=>`Puzzle type`,DAY:()=>`10`,MONTH:()=>`11`,YEAR:()=>`2019`,TAGS:()=>[`Game`,`Puzzle`],FEATURED:()=>true,IMAGE_EXT:()=>`gif`,ONE_LINER:()=>`<p>Are you the ${v.TITLE_BOLD()}? Find out in this cryptic typing puzzle, where every letter <em>counts</em>!</p>`,ORIENTATION:()=>`portrait`,FEEDBACK_KEY:()=>"<kbd>Ctrl</kbd>+<kbd>E</kbd>",FULLSCREEN_KEY:()=>"<kbd>Ctrl</kbd>+<kbd>F</kbd>",HINT_KEY:()=>"<kbd>Ctrl</kbd>+<kbd>H</kbd>",LEVEL_KEY:()=>"<kbd>Ctrl</kbd>+<kbd>L</kbd>",MUSIC_KEY:()=>"<kbd>Ctrl</kbd>+<kbd>M</kbd>"},
...
P_star_battle:{...WithImage,LINK:()=>`star-battle`,TITLE:()=>`Star Battle geometric puzzles`,DAY:()=>`18`,MONTH:()=>`06`,YEAR:()=>`2020`,TYPE:()=>`Post`,TAGS:()=>[`Paper`,`Puzzle`],ONE_LINER:()=>`What if you could play the Star Battle on different geometries?`,IMAGE_EXT:()=>`png`}
}
