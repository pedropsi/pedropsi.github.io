...
CMS={
P_index:{...NoImage,BODY:()=>v.POST(),LINK:()=>`index`,TITLE:()=>v.SITE_NAME(),DATE:()=>"2017-12-01",TYPE:()=>`Home`,TAGS:()=>[`Sitemap`],DESCRIPTION:()=>`${v.SITE_NAME()} home page.`,TYPEGRAPH:()=>`website`},
...
P_game_bar:{...WithImage,LINK:()=>`game-bar`,FEATURED:()=>true,TITLE:()=>`Game Bar`,DATE:()=>"2019-07-27",TAGS:()=>[`Resource`,`Tutorial`,`Puzzlescript`]},
...
P_game_tools:{...WithImage,LINK:()=>`game-tools`,POSTSCRIPT:()=>[`data/puzzlescript-database-component.js`],PRESCRIPT:()=>[`data/puzzlescript-database.js`],TITLE:()=>`Game tools`,DATE:()=>"2019-10-12",TAGS:()=>[`Community`,`List`,`Log`,`Post`,`Puzzlescript`,`Resource`],ONE_LINER:()=>`Useful tools to make games, including puzzlescript forks, wrappers and puzzlescript sprite editors.`},
...
P_status:{...WithImage,LINK:()=>`status`,POSTSCRIPT:()=>["codes/test/test.js"],TITLE:()=>`Status`,DATE:()=>"2019-11-25",TAGS:()=>[`Creative-Archive`,`Resource`,`Sitemap`],ONE_LINER:()=>`Test whether every ${v.SITE_NAME()} function is supported in your browser.`},
P_lul:{...WithImage,LINK:()=>`lul`,TITLE:()=>`Level unlocking language`,SHORTNAME:()=>`LUL`,DATE:()=>"2019-11-30",TAGS:()=>[`Prototype`,`Resource`,`Tutorial`],ONE_LINER:()=>`${v.TITLE()} (LUL) is a simple language to express level precedence rules, also known as level unlocking conditions.`},
P_store:{...WithImage,LINK:()=>`store`,BODY:()=>v.PAGE_BARE(),CONTENT:()=>v.POST(),PRESCRIPT:()=>[/*"https://js.stripe.com/v3",*/"data/store.js"],STYLE:()=>`store`,TITLE:()=>`Store`,DATE:()=>"2019-11-27",TYPE:()=>`Store`,TAGS:()=>[`Creative-Archive`,`Finance`,`List`,`Sitemap`],ONE_LINER:()=>`Shop for exclusive ${v.NAME()} games and more!`,TYPEGRAPH:()=>`site`},
P_press:{...WithImage,LINK:()=>`press`,TITLE:()=>`Press kit`,DATE:()=>"2019-02-02",TYPE:()=>`Post`,TAGS:()=>[`Creative-Archive`,`Press`,`Sitemap`],TYPEGRAPH:()=>`site`},
P_news:{...WithImage,LINK:()=>`news`,TITLE:()=>`News`,DATE:()=>"2019-09-20",TYPE:()=>`Archive`,TAGS:()=>[`Creative-Archive`,`Log`,`Post`,`Press`,`Sitemap`],IMAGE_ALT:()=>`${v.SITE_NAME()} News`,TYPEGRAPH:()=>`site`},

P_mosaic:{...WithImage,IMAGE_NAME:()=>"fleur-de-lis",IMAGE_EXT:()=>"png",LINK:()=>`mosaic`,TITLE:()=>`Mosaic wallpaper gallery`,DATE:()=>"2018-02-14",TAGS:()=>[`Art`,`Travel`,`Wallpaper`],IMAGE_ALT:()=>`Wallpaper gallery`},
...
P_blockworks:{...CMSGame,LINK:()=>`blockworks`,CONTENT:()=>`f9eb8a3e60ba1328a84c3e84db27563a`,THEMECOLOUR:()=>`rgb(69,0,0)`,TITLE:()=>`Blockworks`,DATE:()=>"2018-02-04",TAGS:()=>[`Game`,`Platformer`,`Puzzle`,`Puzzlescript`],ONE_LINER:()=>`<p>Place the blue <em>X Block</em> at the <em>goal</em> (white arrow).Take advantage of auxiliary blocks by thinking creatively and acting timely.</p><p>8 levels only comprise this action puzzle. Good luck!</p>`},
P_whirlpuzzle:{...CMSGame,LINK:()=>`whirlpuzzle`,CONTENT:()=>`8c5602f47f158af57a2db271a8bf5185`,THEMECOLOUR:()=>`rgb(3,2,48)`,TITLE:()=>`Whirlpuzzle`,DATE:()=>"2018-03-01",TAGS:()=>[`Game`,`Puzzle`,`Puzzlescript`],ONE_LINER:()=>`<p>Find a path to the goal, by rotating the puzzle to displace obstacles and reach inaccessible locations! But beware, whirling too much will only confuse you… </p><p>Can you solve all 7 levels in ${v.TITLE_BOLD()}? Good luck!</p>`},
P_unlucky_unlock:{...CMSGame,LINK:()=>`unlucky-unlock`,CONTENT:()=>`9ad4b5559a3e39d9ae0aa5829b02b473`,THEMECOLOUR:()=>`rgb(28,38,50)`,TITLE:()=>`Unlucky Unlock`,DATE:()=>"2014-07-18",TAGS:()=>[`Game`,`Puzzle`,`Puzzlescript`],FEATURED:()=>true,ONE_LINER:()=>`<p>${v.TITLE_BOLD()} is a simple mini_Game of the sliding block type. Moving the pieces to the right positions unlocks each next level.</p> <p>There are four easier levels + three harder levels.</p>`},
P_pmgrp:{...CMSGame,LINK:()=>`pmgrp`,CONTENT:()=>`de00799ea3c9bfb0be74d1030a04c142`,THEMECOLOUR:()=>`rgb(4,71,0)`,TITLE:()=>`Play Mini Gemini Replay (PMGRP)`,SHORTNAME:()=>`PMGRP`,DATE:()=>"2018-03-20",TAGS:()=>[`Game`,`Platformer`,`Puzzle`,`Puzzlescript`],FEATURED:()=>true,ONE_LINER:()=>`<p>${v.TITLE_BOLD()} is a mini puzzle platformer about cooperating with your future self to reach your goals.</p><p>Plan your limited moves wisely, play and replay all 11 levels!</p>`},
...
P_skilleblokker:{...CMSGame,LINK:()=>`skilleblokker`,CONTENT:()=>`d4716388dfe54118a82d4e1ec5d60bc4`,THEMECOLOUR:()=>`rgb(189,224,255)`,TITLE:()=>`Skilleblokker`,DATE:()=>"2019-09-21",TAGS:()=>[`Game`,`Puzzle`,`Puzzlescript`],ONE_LINER:()=>`<p>It is time to disconnect with ${v.TITLE_BOLD()}, the opposite twin of Burokku Konekuta. Can you chill out and isolate every block or will you slip astray on the ice?</p>`},
P_strata_hedges:{...CMSGame,LINK:()=>`strata-hedges`,CONTENT:()=>`74e3b230123627da73d1466eea865f5b`,THEMECOLOUR:()=>`rgb(0,101,101)`,TITLE:()=>`Strata Hedges`,DATE:()=>"2020-03-29",TAGS:()=>[`3D`,`Game`,`Prototype`,`Puzzle`,`Puzzlescript`],ONE_LINER:()=>`<p>The gardens in ${v.TITLE_BOLD()} have many dimensions. Sharpen your eyes and keep all in perspective!</p>`},
P_starkoban:{...CMSGame,LINK:()=>`starkoban`,CONTENT:()=>`f20996db777cfb6f5725fd27c4268cf3`,THEMECOLOUR:()=>`rgb(55,55,55)`,TITLE:()=>`Starkoban`,DATE:()=>"2020-11-14",TAGS:()=>[`Game`,`Puzzle`,`Puzzlescript`],FEATURED:()=>true,ONE_LINER:()=>`<p>${v.TITLE_BOLD()} is a challenging mix of star battle and sokoban, for stark puzzlers.</p>`},
P_puzzle_type:{...CMSGame,LINK:()=>`puzzle-type`,PRESCRIPT:()=>["data/store.js"],POSTSCRIPT:()=>v.GAME_SCRIPT(),TITLE:()=>`Puzzle type`,DATE:()=>"2019-11-10",TAGS:()=>[`Game`,`Puzzle`],FEATURED:()=>true,IMAGE_EXT:()=>`gif`,ONE_LINER:()=>`<p>A <b>single clue</b> reveals the <b>hidden typing rule</b>. Explore each puzzle to discover its rule. To win, type the clue exactly as shown: <b>every symbol counts</b>!</p>`,ORIENTATION:()=>`portrait`,FEEDBACK_KEY:()=>`${KB("Ctrl E")}`,FULLSCREEN_KEY:()=>`${KB("Ctrl F")}`,HINT_KEY:()=>`${KB("Ctrl H")}`,LEVEL_KEY:()=>`${KB("Ctrl L")}`,MUSIC_KEY:()=>`${KB("Ctrl M")}`},
P_terms_of_use:{...NoImage,LINK:()=>`terms-of-use`,TITLE:()=>`Terms of use`,DATE:()=>"2017-11-30",TAGS:()=>[`Creative-Archive`,`Post`]},
