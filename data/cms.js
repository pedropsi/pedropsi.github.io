...
P_game_console:{...CMSGame,LINK:()=>`game-console`,POSTSCRIPT:()=>[`data/puzzlescript-database-game.js`],PRESCRIPT:()=>[`data/puzzlescript-database.js`],TITLE:()=>`Game Console`,DAY:()=>`29`,MONTH:()=>`10`,YEAR:()=>`2019`,TYPE:()=>`Console`,TAGS:()=>[`Community`,`Puzzlescript`,`Resource`],ONE_LINER:()=>`Load any puzzlescript game in ${v.NAME()}'s console and to use the game bar!`,TYPEGRAPH:()=>`website`,IMAGE_EXT:()=>"svg"},
