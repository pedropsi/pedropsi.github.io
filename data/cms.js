...
P_puzzle_type:{...CMSGame,LINK:()=>`puzzle-type`,PRESCRIPT:()=>["data/store.js"],POSTSCRIPT:()=>v.GAME_SCRIPT(),TITLE:()=>`Puzzle type`,DAY:()=>`10`,MONTH:()=>`11`,YEAR:()=>`2019`,TAGS:()=>[`Game`,`Puzzle`],FEATURED:()=>true,IMAGE_EXT:()=>`gif`,ONE_LINER:()=>`<p>Are you the ${v.TITLE_BOLD()}? Find out in this cryptic keyboard typing puzzle!</p>`,ORIENTATION:()=>`portrait`,FEEDBACK_KEY:()=>"<kbd>Alt</kbd>+<kbd>E</kbd>",FULLSCREEN_KEY:()=>"<kbd>Alt</kbd>+<kbd>F</kbd>",HINT_KEY:()=>"<kbd>Alt</kbd>+<kbd>H</kbd>",LEVEL_KEY:()=>"<kbd>Alt</kbd>+<kbd>L</kbd>",MUSIC_KEY:()=>"<kbd>Alt</kbd>+<kbd>M</kbd>"},
