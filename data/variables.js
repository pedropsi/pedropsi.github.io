...
NAVIGATION_TEXT				:	()=>	`<h3>Level navigation</h3><p>Press ${v.LEVEL_KEY()} or <kbd>Level X/Y</kbd> or <kbd>Level selector</kbd> in the game bar to navigate freely ${v.NAVOPTION()}.</p><p>Type the level number directly with ${v.NUM_KEYS()}, press <kbd>Tab</kbd>/<kbd>Shift</kbd>+<kbd>Tab</kbd> or <kbd>${ObtainSymbol("left")}</kbd>/<kbd>${ObtainSymbol("right")}</kbd> to <em>cycle through levels</em>, <kbd>Enter</kbd> or <kbd>Click</kbd> to <em>confirm</em>, <kbd>Esc</kbd> or ${v.LEVEL_KEY()} to <em>cancel</em>.</p>`,
...
LEFT_KEY					:	()=>	`<kbd>${ObtainSymbol("left")}</kbd> or <kbd>A</kbd>`,
UP_KEY						:	()=>	`<kbd>>${ObtainSymbol("up")}</kbd> or <kbd>W</kbd>`,
RIGHT_KEY					:	()=>	`<kbd>>${ObtainSymbol("right")}</kbd> or <kbd>D</kbd>`,
